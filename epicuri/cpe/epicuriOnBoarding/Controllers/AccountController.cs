...
namespace epicuriOnBoarding.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult List()
        {
            ...
            var profiles = uc.UserProfiles;
            var a = profiles.ToList();
        ...
        {
            System.Web.Security.MembershipUser userName = Membership.GetUser(id);
        ...
        public ActionResult DeleteConfirmed(String id)
        {
            ...
            ViewBag.StatusMessage = "User has been deleted";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Manage(String id, LocalPasswordModel model)
        {
            bool hasLocalAccount = OAuthWebSecurity.HasLocalAccount(WebSecurity.GetUserId(User.Identity.Name));
            ...
            if (hasLocalAccount)
            {
                if (ModelState.IsValid)
                {
                    ...
                    try
                    {
                        string token = WebSecurity.GeneratePasswordResetToken(id);
