...
public class WaitingControllerTest extends BaseIT {
    ...
    @Test
    public void testPostPartyWithOrderAndAdjustments1() throws Exception {
        ...
        AdjustmentRequest request1 = createAdjustmentRequest(0.01, NumericalAdjustmentType.ABSOLUTE, adjustmentType2);
        AdjustmentRequest request2 = createAdjustmentRequest(0.02, NumericalAdjustmentType.ABSOLUTE, adjustmentType2);
        ...
        assertTrue(session.getAdjustments().stream().anyMatch(a -> a.getValue() == 1));
        assertTrue(session.getAdjustments().stream().anyMatch(a -> a.getValue() == 2));
    }

    @Test
    public void testPostPartyWithOrderAndAdjustments2() throws Exception {
        setUpItemsAndOrdersAndAdjustments();
        String token = getTokenForStaff(staff1);
        ...
        AdjustmentRequest request1 = createAdjustmentRequest(0.09, NumericalAdjustmentType.ABSOLUTE, adjustmentType2);
        AdjustmentRequest request2 = createAdjustmentRequest(0.04, NumericalAdjustmentType.ABSOLUTE, adjustmentType2);
        ...
        assertPaidAndValuesPresent(token, payload, 4, 9);
    }

    private void assertPaidAndValuesPresent(String token, WaitingPartyOrderAndAdjustmentsPayload payload, Integer value1, Integer value2) {
        Response response = given()
                .accept(MediaType.APPLICATION_JSON_VALUE)
                .contentType(MediaType.APPLICATION_JSON_VALUE)
                .header(Params.AUTHORIZATION, token)
        ...
        if(value1 != null) assertTrue(session.getAdjustments().stream().anyMatch(a -> a.getValue() == value1));
        if(value2 != null) assertTrue(session.getAdjustments().stream().anyMatch(a -> a.getValue() == value2));
    }

    @Test
    public void testPostPartyWithOrderAndDiscounts1() throws Exception {
        setUpItemsAndOrdersAndAdjustments();
        String token = getTokenForStaff(staff1);
        ...
        AdjustmentRequest request1 = createAdjustmentRequest(50, NumericalAdjustmentType.PERCENTAGE, adjustmentType1); //discount
        AdjustmentRequest request2 = createAdjustmentRequest(0.07, NumericalAdjustmentType.ABSOLUTE, adjustmentType2); //payment
        ...
        assertPaidAndValuesPresent(token, payload, 500, 7);
    }

    @Test
    public void testPostPartyWithOrderAndDiscounts2() throws Exception {
        setUpItemsAndOrdersAndAdjustments();
        String token = getTokenForStaff(staff1);
        ...
        AdjustmentRequest request1 = createAdjustmentRequest(0.09, NumericalAdjustmentType.ABSOLUTE, adjustmentType1); //discount
        AdjustmentRequest request2 = createAdjustmentRequest(0.04, NumericalAdjustmentType.ABSOLUTE, adjustmentType2); //payment
        ...
        assertPaidAndValuesPresent(token, payload, 9, 4);
    }

    public AdjustmentRequest createAdjustmentRequest(double v, NumericalAdjustmentType type, AdjustmentType adjustmentType) {
        AdjustmentRequest request1 = new AdjustmentRequest();
        request1.setAdjustmentTypeId(adjustmentType.getId());
        request1.setNumericalTypeId(NumericalAdjustmentType.toClientId(type));
    ...
    public void testPostPartyWithOrderAndAdjustmentsImmediatePrint() throws Exception {
        ...
        AdjustmentRequest request1 = createAdjustmentRequest(0.01, NumericalAdjustmentType.ABSOLUTE, adjustmentType2);
        AdjustmentRequest request2 = createAdjustmentRequest(0.09, NumericalAdjustmentType.ABSOLUTE, adjustmentType2);
