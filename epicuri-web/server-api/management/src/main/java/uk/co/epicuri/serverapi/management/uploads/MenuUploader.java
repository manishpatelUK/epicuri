...
public class MenuUploader {
    public static void main(String[] args) {
        ...
        File file = getFile(args[4]);
        String restaurantId = args[0].trim();
        String userName = args[1].trim();
        String password = args[2].trim();

        WebService api = getWebService(args, restaurantId, userName, password);

        MenuUploader menuUploader = new MenuUploader(api, restaurantId);
        menuUploader.upload(file);
    }

    public static WebService getWebService(String[] args, String restaurantId, String userName, String password) {
    ...
    public static void waitForKill() {
