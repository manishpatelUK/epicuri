...
public class RestaurantController {
    ...
    public ResponseEntity<?> getRestaurants(@RequestHeader(Params.AUTHORIZATION) String token,
        ...
        LocationAndCustomerView locationAndCustomerView = getLocationAndCustomerView(latitude, longitude, list);
    ...
    @RequestMapping(value = "/onLocation", method = RequestMethod.GET, consumes = MediaType.ALL_VALUE)
    public ResponseEntity<?> getRestaurantsOnLocation(
                                            @RequestParam(value = "latitude") double latitude,
                                            @RequestParam(value = "longitude") double longitude,
                                            @RequestParam(value = "restaurantId", required = false) String restaurantId,
                                            @RequestParam(value = "name", required = false) String name) {
    ...
    private LocationAndCustomerView getLocationAndCustomerView(@RequestParam("latitude") double latitude, @RequestParam("longitude") double longitude, List<Restaurant> list) {
        ...
        return locationAndCustomerView;
    }
