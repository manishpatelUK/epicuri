...
public class MasterDataService {
    ...
    public AdjustmentType getDeferredPaymentType(String restaurantId) {
        Restaurant restaurant = getRestaurant(restaurantId);
        List<AdjustmentType> adjustmentTypes = getAdjustmentTypes(restaurant.getAdjustmentTypes());
        return adjustmentTypes.stream().filter(a -> a.getType() == AdjustmentTypeType.DISCOUNT && a.getName().equals(RestaurantConstants.DEFER_ADJUSTMENT)).findFirst().orElse(null);
    }
    ...
    public BookingStatics insertBookingStatics(BookingStatics bookingStatics) {
        return upsertBookingStatics(bookingStatics);
    }
