...
public class RevenueReportLine extends AbstractReportLine {
    ...
    @CsvBindByName(column = "Settlement of Account Session ID")
    @CsvSortOrder(order = 20)
    private String deferredSessions;
    ...
    public String getDeferredSessions() {
        return deferredSessions;
    }

    public void setDeferredSessions(String deferredSessions) {
