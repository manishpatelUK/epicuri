...
public class LiveDataService {
    ...
    public CustomerInteractionDeferredSession saveInteraction(CustomerInteractionDeferredSession customerInteractionDeferredSession) {
        return customerInteractionRepository.save(customerInteractionDeferredSession);
    }

    public List<CustomerInteractionDeferredSession> getDeferredSessions(String restaurantId, boolean paid) {
        return customerInteractionRepository.findByRestaurantIdAndPaid(restaurantId, paid);
    }

    public CustomerInteractionDeferredSession getDeferredSession(String restaurantId, String sessionId) {
        return customerInteractionRepository.findByRestaurantIdAndSessionId(restaurantId, sessionId);
    }

    public void deleteCustomerInteraction(String id) {
        customerInteractionRepository.delete(id);
    }
