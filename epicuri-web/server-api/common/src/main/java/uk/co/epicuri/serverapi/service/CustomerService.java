...
public class CustomerService {
    ...
    public List<Customer> getCustomers(List<String> ids) {
        return Lists.newArrayList(customerRepository.findAll(new HashSet<>(ids)));
    }
    ...
    private Customer createCustomer(Customer customer, boolean sendConfirmation) {
        customer = insert(customer);

        if(!masterDataService.isTestEnvironment() && sendConfirmation) {
    ...
    public Customer createCustomer(String regionCode, String phoneNumber, String emailAddress, String firstName, String lastName) {
        return createCustomer(regionCode, phoneNumber, emailAddress, firstName, lastName, true);
    }

    public Customer createCustomer(String regionCode, String phoneNumber, String emailAddress, String firstName, String lastName, boolean sendConfirmation) {
        ...
        return createCustomer(customer, sendConfirmation);
    }
    ...
    public List<CustomerInteraction> getCustomerInteractions(String restaurantId) {
        return customerInteractionRepository.findByRestaurantId(restaurantId);
    }
}
