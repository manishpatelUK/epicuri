...
public abstract class BaseIT {
    ...
    @Autowired
    protected CustomerInteractionRepository customerInteractionRepository;
    ...
    private void createDefaults() {
        ...
        defaultsRepository.save(new Default(FixedDefaults.APPLY_AUTOTIP_TO_QO,false,null,null,0));
    }
