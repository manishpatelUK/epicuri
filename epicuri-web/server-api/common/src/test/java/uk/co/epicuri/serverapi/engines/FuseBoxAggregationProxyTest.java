...
public class FuseBoxAggregationProxyTest extends SessionSetupBaseIT {
    ...
    @Test
    public void testIsClosedForTakeawaysMidnightClosures() throws Exception {
        openingHours1.setBookingType(BookingType.TAKEAWAY);
        setOpenAllDay(openingHours1, DayOfWeek.THURSDAY);
        setCloseAllDay(openingHours1, DayOfWeek.FRIDAY);
        openingHoursRepository.save(openingHours1);

        FuseBoxAggregationProxy proxy = getTakeawayProxyWithBookingAndSession();
        assertFalse(proxy.isClosedForTakeaways());

        setCloseAllDay(openingHours1, DayOfWeek.THURSDAY);
        openingHoursRepository.save(openingHours1);
    ...
    @Test
    public void testIsClosedForTakeawaysPartialFollowedByMidnightClosures() throws Exception {
        openingHours1.setBookingType(BookingType.TAKEAWAY);
        setOpenClose(openingHours1, 15,0,22,0,DayOfWeek.THURSDAY);
        setCloseAllDay(openingHours1, DayOfWeek.FRIDAY);
        openingHoursRepository.save(openingHours1);
    ...
    private void setOpenClose(OpeningHours openingHours, int openH, int openM, int closeH, int closeM, DayOfWeek dayOfWeek) {
        List<HourSpan> hours = new ArrayList<>();
        HourSpan hourSpan = new HourSpan(openH,openM,closeH,closeM);
        hours.add(hourSpan);
        openingHours.getHours().put(dayOfWeek, hours);
    }

    private void setOpenAllDay(OpeningHours openingHours, DayOfWeek dayOfWeek) {
        setOpenClose(openingHours, 0,0,24,0, dayOfWeek);
    }

    private void setCloseAllDay(OpeningHours openingHours, DayOfWeek dayOfWeek) {
        openingHours.getHours().put(dayOfWeek, new ArrayList<>());
    }
