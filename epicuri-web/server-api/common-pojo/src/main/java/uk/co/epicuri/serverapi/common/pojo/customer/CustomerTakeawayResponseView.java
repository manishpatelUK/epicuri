...
public class CustomerTakeawayResponseView {
    ...
    @JsonProperty("prettyDateTime")
    private String prettyDateTime = "Unknown";
    ...
    public CustomerTakeawayResponseView(Session session,
        ...
        this.paid = paid;
        this.prettyDateTime = TimeUtil.toString(booking.getTargetTime(), restaurant.getIANATimezone());

        List<CustomerOrderView> customerOrderViews = new ArrayList<>();
        for(Order order : orders) {
            customerOrderViews.add(new CustomerOrderView(order, null, session.getService()));
        }
        takeawayDetail.setOrders(customerOrderViews);
    }
    ...
    public void setPrettyDateTime(String prettyDateTime) {
