...
public class HourSpan implements Comparable<HourSpan>{
    ...
    public int compareTo(HourSpan o) {
        ...
        return Integer.compare(thisMinutesOpen, thatMinutesOpen);
    }

    @Override
    public String toString() {
        return new ToStringBuilder(this)
                .append("hourOpen", hourOpen)
                .append("minuteOpen", minuteOpen)
                .append("hourClose", hourClose)
                .append("minuteClose", minuteClose)
                .toString();
    }
}
