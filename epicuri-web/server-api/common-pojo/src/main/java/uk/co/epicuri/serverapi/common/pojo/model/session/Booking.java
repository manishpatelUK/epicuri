...
public class Booking extends Deletable implements Comparable<Booking>{
    ...
    public Booking(Booking original) {
        ...
        this.staffId = original.getStaffId();
    }
    ...
    public Booking(String restaurantId, HostReservationRequest request, Customer customer, String staffId) {
        this(restaurantId, request, staffId);
        if(customer != null) {
            this.customerId = customer.getId();
        ...
        if(customer == null && StringUtils.isNotBlank(request.getEmail())) {
    ...
    public Booking(String restaurantId, HostReservationRequest request, String staffId) {
