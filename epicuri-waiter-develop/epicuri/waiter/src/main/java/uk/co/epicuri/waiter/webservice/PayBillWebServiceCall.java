...
public class PayBillWebServiceCall implements WebServiceCall {
...
Returns: 400, 403, 200. No response on success
	 ...
	 */
	public PayBillWebServiceCall(String sessionId){
		path = String.format("/Session/PayBill/%s", sessionId);
		body = "";
