...
import uk.co.epicuri.waiter.interfaces.OnTimeChangedListener;
 ...
 */
public class TenMinuteTimePicker extends FrameLayout {
	...
	private static final OnTimeChangedListener NO_OP_CHANGE_LISTENER = new OnTimeChangedListener() {
		public void onTimeChanged(TenMinuteTimePicker view, int hourOfDay, int minute) {
		}
	};
	...
	private final View mAmPmButton;
	...
	public TenMinuteTimePicker(Context context) {
		this(context, null);
	}

	public TenMinuteTimePicker(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public TenMinuteTimePicker(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);

		LayoutInflater inflater = (LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		inflater.inflate(R.layout.timepicker, this, // we are the parent
				true);
		...
		mMinutePicker.setDisplayedValues(new String[]{"O'Clock","10","20","30","40","50"});
		mMinutePicker.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() {

			@Override
			public void onValueChange(NumberPicker picker, int oldVal, int newVal) {
				mCurrentMinute = newVal * 10;
				onTimeChanged();
			}
		});
...
//		mAmPmButton.setText(mIsAm ? mAmText : mPmText);
	...
	private void configurePickerRanges() {
		...
		if (mIs24HourView) {
			...
			mMinutePicker.setMinValue(0);
			mMinutePicker.setMaxValue(5);
			mMinutePicker.setDisplayedValues(new String[]{"00","10","20","30","40","50"});
//			mHourPicker.setFormatter(NumberPicker.TWO_DIGIT_FORMATTER);
	...
	private void updateMinuteDisplay() {
		mMinutePicker.setValue(mCurrentMinute / 10);
		mOnTimeChangedListener.onTimeChanged(this, getCurrentHour(),
				getCurrentMinute());
	}
}
