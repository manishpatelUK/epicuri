...
import uk.co.epicuri.waiter.ui.menueditor.EditMenuItemActivity;
...
public class HubActivity extends EpicuriBaseActivity implements NewPartyDialogListener, OnTableChangeListener, HubListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (menu.findItem(R.id.kick_drawer) != null)
            menu.findItem(R.id.kick_drawer).setVisible(LocalSettings.getInstance(this).isAllowed(WaiterAppFeature.MANUAL_DRAWER_KICK));
