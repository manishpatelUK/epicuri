 ...
 */
public class AdhocAcknowledgementControllerTest extends SessionSetupBaseIT {
    @Test
    public void postAcknowledgement() throws Exception {
        Response response;
        String token;
        ...
        response = given()
                ...
                .post("AdhocAcknowledgement/"+notificationId);
        ...
        notificationId = notification1.getId()+"i";
